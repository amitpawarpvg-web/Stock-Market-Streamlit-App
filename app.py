...
if company_name :
    ...
    if company_data:
        ...
        COMPANY_NAME = st.success(f"**COMPANY_NAME**: , {company_data[option][0]}")
        COMPANY_REGION = st.success(f"**COMPANY_region**: , {company_data[option][1]}")
        COMPANY_CURRENCY = st.success(f"**COMPANY_currency**: , {company_data[option][2]}")
